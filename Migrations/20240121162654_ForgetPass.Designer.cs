...
namespace CourseSignupSystem.Migrations
{
    ...
    [Migration("20240121162654_ForgetPass")]
            ...
            modelBuilder.Entity("CourseSignupSystem.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 1, 21, 23, 26, 52, 847, DateTimeKind.Local).AddTicks(8911),
                            ...
                            RoleId = "QTV01",
                            Sex = 1,
                            UpdateDate = new DateTime(2024, 1, 21, 23, 26, 52, 847, DateTimeKind.Local).AddTicks(8923),
                            UserName = "Admin",
