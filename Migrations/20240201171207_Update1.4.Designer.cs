...
namespace CourseSignupSystem.Migrations
{
    ...
    [Migration("20240201171207_Update1.4")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseSignupSystem.Models.Class_Schedule", b =>
                {
                    ...
                    b.ToTable("R_Class_Schedule", (string)null);
                });
            ...
            modelBuilder.Entity("CourseSignupSystem.Models.Subject", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 2, 2, 0, 12, 4, 752, DateTimeKind.Local).AddTicks(2973),
                            FacultyId = "NOTSET_FACULTY",
            ...
            modelBuilder.Entity("CourseSignupSystem.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 2, 2, 0, 12, 4, 750, DateTimeKind.Local).AddTicks(8493),
                            ...
                            RoleId = "QTV01",
                            Sex = 1,
                            UpdateDate = new DateTime(2024, 2, 2, 0, 12, 4, 750, DateTimeKind.Local).AddTicks(8505),
                            UserName = "Admin",
            ...
            modelBuilder.Entity("CourseSignupSystem.Models.Student", b =>
                {
                    b.HasOne("CourseSignupSystem.Models.User", "GetUser")
                        .WithOne("Co_Student")
                        .HasForeignKey("CourseSignupSystem.Models.Student", "UserId")
                        .IsRequired()
            ...
            modelBuilder.Entity("CourseSignupSystem.Models.Teacher", b =>
                {
                    b.HasOne("CourseSignupSystem.Models.User", "GetUser")
                        .WithOne("Co_Teacher")
                        .HasForeignKey("CourseSignupSystem.Models.Teacher", "UserId")
                        .IsRequired()
            ...
            modelBuilder.Entity("CourseSignupSystem.Models.Class", b =>
                {
                    ...
                    b.Navigation("Co_Class_Schedules");
