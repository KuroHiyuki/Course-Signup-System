...
namespace CourseSignupSystem.Migrations
{
    ...
    [Migration("20240122075207_UpdateUser")]
            ...
            modelBuilder.Entity("CourseSignupSystem.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 1, 22, 14, 52, 5, 866, DateTimeKind.Local).AddTicks(8586),
                            ...
                            RoleId = "QTV01",
                            Sex = 1,
                            UpdateDate = new DateTime(2024, 1, 22, 14, 52, 5, 866, DateTimeKind.Local).AddTicks(8601),
                            UserName = "Admin",
