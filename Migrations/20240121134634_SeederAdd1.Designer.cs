...
namespace CourseSignupSystem.Migrations
{
    ...
    [Migration("20240121134634_SeederAdd1")]
    partial class SeederAdd1
    {
            ...
            modelBuilder.Entity("CourseSignupSystem.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 1, 21, 20, 46, 34, 245, DateTimeKind.Local).AddTicks(3198),
                            ...
                            RoleId = "QTV01",
                            Sex = 1,
                            UpdateDate = new DateTime(2024, 1, 21, 20, 46, 34, 245, DateTimeKind.Local).AddTicks(3208),
                            UserName = "Admin",
